        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{ asset('quiz/assets/img/blog-post-2.jpg') }}" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{ asset('quiz/assets/img/blog-post-3.jpg') }}" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{ asset('quiz/assets/img/blog-post-4.jpg') }}" alt="" class="img-fluid">
              </div>
